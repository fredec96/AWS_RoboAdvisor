...
def validate_data(age, investment_amount, intent_request):
    ...
    """
    # Validate age, should be < 65 to use the service
    if age is not None:
        age = parse_int(
            age
        )
        if age >= 65:
            ...
            return build_validation_result(
                False,
                "age",
                "Please provide a valid age between 65 and 0 years old.",
            )
...
def get_recommendation(risk_level):
    # Make investment recommendations based off of risk tollerance.
    """
    Returns an investment recommendation based on the users selected risk tollerance.
    """
...
def recommend_portfolio(intent_request):
    ...
    return close(
        ...
        "Fulfilled",
        {
            ...
            """.format(
                first_name, get_recommendation(risk_level)
            ),
        },
    )
